...
public class Main {
	public static void main(String[] args) {
		...
		//optimisation();
		//testVsIa();
		Eval eval2 = new Eval2();
		EvalLambda evalLambda = new EvalLambda();
		testLambdaVSEval2(4,2,eval2,evalLambda);
	}

	public static boolean testLambdaVSEval2(int taille, int profondeur, Eval evalp0, Eval evalp1){
		boolean jouer=true;
	...
	public static float optimisation(){
		...
		while (evalLambda.getLambda() - evalLambdaP.getLambda() <= 0.1){
			victoirep0 = jouerEval(4,2,evalLambda,evalLambdaP);
			if (victoirep0){
	...
	public static void test2Joueurs(){
		Scanner sc= new Scanner(System.in);
		boolean jouer=true;
		boolean joueur0 = true;
		boolean finJ0, finJ1;
	...
	public static void testPremierCoupRock(){
		Scanner sc= new Scanner(System.in);
		boolean jouer=true;
		boolean joueur0 = true;
		boolean tour1 = true;
